...
public class View extends JFrame implements ActionListener {
	...
	private JLabel s1CurrentLabel;
	private JLabel s2CurrentLabel;
	...
	private void initialize() {
		...
		s1CurrentLabel = new JLabel("");
		GridBagConstraints gbc_s1CurrentLabel = new GridBagConstraints();
		gbc_s1CurrentLabel.gridwidth = 2;
		gbc_s1CurrentLabel.insets = new Insets(0, 0, 5, 5);
		gbc_s1CurrentLabel.gridx = 2;
		gbc_s1CurrentLabel.gridy = 2;
		searchPanel.add(s1CurrentLabel, gbc_s1CurrentLabel);

		s2CurrentLabel = new JLabel("");
		GridBagConstraints gbc_s2CurrentLabel = new GridBagConstraints();
		gbc_s2CurrentLabel.gridwidth = 2;
		gbc_s2CurrentLabel.insets = new Insets(0, 0, 5, 5);
		gbc_s2CurrentLabel.gridx = 2;
		gbc_s2CurrentLabel.gridy = 3;
		searchPanel.add(s2CurrentLabel, gbc_s2CurrentLabel);
	...
	public void setS1Current(String s) {
		s1CurrentLabel.setText(s);
	}
	
	public void setS2Current(String s) {
		s2CurrentLabel.setText(s);
	}
